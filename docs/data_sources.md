...
**Локальное железо** (`RTX 4060 Ti 8GB`): использовать Smoke preset — полный movies-датасет (16M рёбер) на этом GPU HW-bound (~10 ч/эпоха), Smoke даёт ~1 мин/эпоха. Полные тренировки — Colab. Подробнее: см. `spec/local-training.md` раздел A1.7.
